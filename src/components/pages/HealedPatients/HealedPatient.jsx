...
const HealedPatient = () => {
  ...
  return (
    <>
      <Helmet>
        <title>درمان شدگان-{post.title.rendered}</title>
      </Helmet>
      <main id="main">
        {/* ======= Healed Patient Section ======= */}
        <section className="healedPatient">
