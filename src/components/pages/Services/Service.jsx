...
const Service = () => {
  ...
  return (
    <>
      <Helmet>
        <title>خدمات ما-{post.title.rendered}</title>
      </Helmet>
      <main id="main">
        {/* ======= Service Section ======= */}
        <section className="service">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              ...
              <img
                className="service-image mx-auto d-block img-fluid rounded w-100 mt-3"
                src={
            ...
            <div className="row mt-5">
              <div className="content service-content col-12">
                {parse(post.content.rendered)}

                <div className="row service-information">
                          ...
                          {postTags.map((tag) => {
                            return (
                              <li key={tag.id} className="p-1">
                                <Link
                                  to={`/services/tags/${tag.id}/${tag.name}/${
                                    postCategories.length > 0 &&
                                    postCategories[0].id +
                                      "/" +
