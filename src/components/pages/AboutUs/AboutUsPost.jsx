...
const AboutUsPost = () => {
  ...
  return (
    <>
      <Helmet>
        <title>درباره ما-{post.title.rendered}</title>
      </Helmet>
      <main id="main">
        {/* ======= About Us Post Section ======= */}
        <section className="aboutUsPost">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              ...
              <img
                className="aboutUsPost-image mx-auto d-block img-fluid rounded w-100 mt-3"
                src={
                        ...
                        <ul>
                          {postTags.map((tag) => {
                            return (
                              <li key={tag.id}>
                                <Link
                                  to={`/about-us/tags/${tag.id}/${tag.name}/${
                                    postCategories.length > 0 &&
                                    postCategories[0].id +
                                      "/" +
